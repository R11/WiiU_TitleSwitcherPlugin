...
inline TitleInfo sMockTitles[] = {
    { 0x0005000010145D00, "Super Mario 3D World" },
    { 0x000500001010EC00, "Mario Kart 8" },
    { 0x0005000010176900, "Splatoon" },
    { 0x0005000010145000, "Super Smash Bros. for Wii U" },
    { 0x00050000101C9400, "The Legend of Zelda: Breath of the Wild" },
    { 0x0005000010172600, "Bayonetta 2" },
    { 0x0005000010145200, "Pikmin 3" },
    { 0x0005000010116100, "Xenoblade Chronicles X" },
    { 0x0005000010143500, "Hyrule Warriors" },
    { 0x0005000010138300, "Donkey Kong Country: Tropical Freeze" },
    { 0x0005000010175B00, "Captain Toad: Treasure Tracker" },
    { 0x0005000010184D00, "Yoshi's Woolly World" },
    { 0x0005000010185300, "Star Fox Zero" },
    { 0x0005000010132200, "NES Remix Pack" },
    { 0x000500301001500A, "Mii Verse" },
    { 0x000500301001200A, "Nintendo eShop" },
    { 0x000500301001000A, "Internet Browser" },
    { 0x0005000010199500, "Tokyo Mirage Sessions FE" },
    { 0x0005000010180600, "Pokken Tournament" },
    { 0x0005000010162B00, "Super Mario Maker" },
};
