...
BUILD		:=	build
SOURCES		:=	src src/input src/render src/titles src/storage src/menu src/utils src/editor src/presets
DATA		:=	data
INCLUDES	:=	src src/input src/render src/titles src/storage src/menu src/utils src/editor src/presets
