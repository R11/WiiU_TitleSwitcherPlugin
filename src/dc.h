/**
 * Display Controller Register Access
 * Based on WiiUPluginLoaderBackend's dc.h
 * Reference: https://www.x.org/docs/AMD/old/42589_rv630_rrg_1.01o.pdf
 */
...
// Register IDs (from AMD documentation, reg id / 4)
